...
class SingleNode extends Module
{
    String name;
    Vertex theVertex;
    int vertexType;
    ...
    public SingleNode(String name, int distribType, int vertexType, String label)
    {
	this.name = name;
    ...
    public SingleNode(String name, double[] initDistrib, int vertexType, String label)
    {
	this.name = name;
	this.vertexType = vertexType;
    ...
    public void setPriorfile(int nr, String pf)
    {
	switch(nr) {
	case 1:
	    priorfile = pf;
