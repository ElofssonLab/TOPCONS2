...
$gnuplot="$programpath/gnuplot/bin/gnuplot";
...
Modified from the original perl script by Nanjiang Shu, created 2010-09-01, updated 2010-09-02

Examples:
     dG_predTM.pl test.fa -o rst.html
# to get dG for all sliding windows, keep the temporary files 
     dG_predTM.pl test.fa -o rst.html -tmpdir data -nc
...
system("mkdir -p plots/$tmpname -m 0777") ;#|| dieHTML("Could not create temporary directory plots/$tmpname.\n");
my $break=1;
