...
my $c0=0; my $c1=0; my $c2=0; my $c3=0;
...
print "<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" width=\"100%\" class=\"TableGrey\">\n";
#print "<tr><td rowspan=100><img src='0.gif' border=0 width=30 height=1></td></tr>\n";
#print "<tr><td colspan=4><img src=\"0.gif\" border=0 width=750 height=30></td></tr>\n";
#print "<tr><td align=\"left\" colspan=4><big><big>Results</big></big><br><br><br><br><br></td></tr>\n";

unless (scalar(@seq)) {
    print "<tr><td>No sequence entered!</td></tr></table><br><br><br><br>\n";
    exit;
} elsif (scalar(@seq) > $max_seq_length) {
    print "<tr><td>Sequence too long (> $max_seq_length aa.)</td></tr></table><br><br><br><br>\n";
    exit;
}    

print "<tr><td colspan=4 align=left><table width=\"100%\" cellspacing=0 cellpadding=0 border=0>\n";
if ($allow_sub) {
    print "<tr><td valign='top'><i>Sequence</i><br><small>(Subsequence with lowest &Delta;G marked in <span style='color:#FF8800'>orange</span>)</small></td><td>&nbsp;</td><td valign='top'><i>Predicted&nbsp;&Delta;G</i></td><td>&nbsp;</td></tr>\n";
    print "<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>\n";
} else {
    print "<tr><td><i>Sequence</i></td><td><img src='0.gif' height=1 width=50></td><td><i>Predicted&nbsp;&Delta;G</i></td><td>&nbsp;</td></tr>\n";
    print "<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>\n";
}
...
while($helix=shift(@seq)) {
    ...
    ($helix =~ /^\s+$/) && (print "<tr><td colspan=4>&nbsp;</td></tr>\n") && next;
    $helix =~ s/\s*$//;
    $helix =~ s/^\s*//;
    $helix =~ tr/a-z/A-Z/;
    unless ($helix =~ /^[ABCDEFGHIKLMNPQRSTUVWXYZ]+$/) {
	print "<tr><td>$helix</td><td>&nbsp;</td><td colspan=2>Sequence error. </td></tr>\n";
	next;
    }
    $Length=length($helix);
    if ($Length > 40) {
	print "<tr><td>" . substr($helix,0,40) . "... </td><td>&nbsp;</td><td colspan=2>Length error (> 40 residues)</td></tr>\n";
	next;
    }
    if ($Length < 9) {
	print "<tr><td>$helix</td><td>&nbsp;</td><td colspan=2>Length error (< 9 residues)</td></tr>\n";
	next;
    }
    ...
    print "<tr><td>$helix</td><td>&nbsp;</td><td>$helix_dG</td>";
    $helix =~ s/^.*?\>//; $helix =~ s/<.*$//;
    print "<td><a href=\"analyze.php?with_length=$with_length&seq=$helix\" target=\"_blank\" style='text-decoration:none' onClick=\"javascript:analyze('$helix');return false;\"><span style='text-decoration: none;color: #800000;'>[analyze]</span></a></td></tr>\n";
}
print "</table><br><br><br><br></td></tr></table>\n";
